...
export default function AchievementsSection({ layoutType }: { layoutType: "page" | "section" | undefined }) {

  return (
    <section className="py-16 md:py-24 bg-white relative overflow-hidden" dir="rtl">
      {/* Ambient backgrounds */}
      <div className="absolute top-0 right-0 w-125 h-125 bg-secondary/5 rounded-full blur-3xl pointer-events-none -translate-y-1/2 translate-x-1/4" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        <div className="mb-10">
          <AchievementsGrid layoutType="section" />
        </div>
