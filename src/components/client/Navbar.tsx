...
export default function Navbar() {
  ...
  return (
    <>
      {/* ── Top Info Bar ── */}
      <div className="bg-[#11395f] text-white text-[11px] min-[380px]:text-xs sm:text-[13px] relative border-b border-white/10 w-full overflow-hidden min-[499px]:block hidden z-100">
